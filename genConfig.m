...
switch(dataset)
    case {'otb'}
        % path to OTB dataset
        benchmarkSeqHome ='../dataset/Drone2108/VisDrone2018-SOT-train/';
        ...
        switch(config.seqName)
            ...
            otherwise
                config.imgDir = fullfile(benchmarkSeqHome, 'sequences',config.seqName);
        end
        ...
        switch(config.seqName)
           ...
           % case 'Skating2-2'
            ...
            otherwise
                ...
                gtPath = fullfile(benchmarkSeqHome,'annotations', [config.seqName,'.txt']);
        end
